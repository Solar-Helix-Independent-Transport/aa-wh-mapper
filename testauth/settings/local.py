...
# Websockets (django-channels), used for wh_mapper's live map updates.
ASGI_APPLICATION = "testauth.asgi.application"
if "test" in sys.argv:
    # Keep the test suite self-contained - no Redis required to run it.
    ...
    CHANNEL_LAYERS = {
        "default": {
            ...
            "CONFIG": {
                # Separate DB index from Celery's broker (db 0) above.
